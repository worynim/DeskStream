...
### 4. Interactive Web Dashboard & Real-time Sync
...
## 📖 사용 방법
1. **WiFi 설정**: 처음 부팅 시 생성되는 `Korean_Clock_Setup` AP에 접속하여 WiFi 정보를 입력합니다.
