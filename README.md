...
### 1. [Smart_Info_Station: 스마트 정보 스테이션 (v2.6.0)](./Smart_Info_Station/)
...
### 6. [DS_DECK: 프로그래머블 매크로 패드 (v1.1.2)](./DS_DECK/)
...
### 7. [Screen_To_OLEDs: 실시간 화면 스트리머 (New)](./Screen_To_OLEDs/)
- **기능**: PC/Mac의 화면 일부를 캡처하여 DeskStream 4-OLED 매트릭스에 실시간으로 전송.
- **특징**: **macOS 투명 윈도우 버그 완벽 해결**(4-선 오버레이), Portrait(세로형) 64x512 전송 지원, 실시간 이진화(Dithering/Threshold) 처리, 드래그 위치 기억 및 저지연 UDP 전송.
- **버튼 동작**: 버튼 2를 눌러 밝기를 순환 조절하고, 버튼 1을 롱프레스하여 화면을 180도 회전(플립)합니다.
